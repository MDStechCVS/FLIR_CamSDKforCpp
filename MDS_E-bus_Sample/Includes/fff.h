...
/**
   Display parameters
*/
struct DISPLAY_PAR_T
{
    float yxPixRatio;            //!< y/x pixel size for non square pixels.
    
    float zoomFactor;            //!< 1.0 = normal size

    long  reserved[5];          //!< For future use - should be set to 0
...
struct _bidata_t 
{
    ...
    DISPLAY_PAR_T		DisplayParameters;
